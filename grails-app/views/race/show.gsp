            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="race.startDate.label" default="Start Date & Time" /></td>
                            
                            <td valign="top" class="value"><g:formatDate format="yyyy-MM-dd @ HH:mm z" date="${raceInstance?.startDate}" /></td>
