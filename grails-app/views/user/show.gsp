            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.captain.label" default="Captain Name" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: userInstance, field: "captain")}</td>
