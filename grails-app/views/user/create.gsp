                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="captain"><g:message code="user.captain.label" default="Captain Name" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: userInstance, field: 'captain', 'errors')}">
                                    <g:textField name="captain" value="${userInstance?.captain}" />
                                </td>
                            </tr>
